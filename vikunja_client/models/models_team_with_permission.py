...
T = TypeVar("T", bound="ModelsTeamWithPermission")


@_attrs_define
class ModelsTeamWithPermission:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        models_team_with_permission = cls(
            created=created,
        ...
        models_team_with_permission.additional_properties = d
        return models_team_with_permission
