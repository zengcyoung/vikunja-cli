...
T = TypeVar("T", bound="NotificationsDatabaseNotification")
...
class NotificationsDatabaseNotification:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        notifications_database_notification = cls(
            created=created,
            id=id,
            name=name,
        ...
        notifications_database_notification.additional_properties = d
        return notifications_database_notification
