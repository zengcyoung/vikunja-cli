...
from ...models.v1_user_password_confirmation import V1UserPasswordConfirmation
...
def _get_kwargs(
    *,
    body: V1UserPasswordConfirmation,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Request the deletion of the user
     ...
     Requests the deletion of the current user. It will trigger an email which has to be confirmed to
    start the deletion.
