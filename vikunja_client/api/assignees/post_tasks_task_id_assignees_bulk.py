...
from ...models.models_bulk_assignees import ModelsBulkAssignees
...
def _get_kwargs(
    task_id: int,
    *,
    body: ModelsBulkAssignees,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/tasks/{task_id}/assignees/bulk".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Add multiple new assignees to a task
     ...
     Adds multiple new assignees to a task. The assignee needs to have access to the project, the doer
    must be able to edit this task. Every user not in the project will be unassigned from the task, pass
    an empty array to unassign everyone.
